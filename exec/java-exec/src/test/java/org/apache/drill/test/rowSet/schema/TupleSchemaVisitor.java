...
public class TupleSchemaVisitor extends TupleSchemaParserBaseVisitor<TupleSchema> {
  ...
  public static class ColumnVisitor extends TupleSchemaParserBaseVisitor<ColumnMetadata> {
    ...
    @Override
    public ColumnMetadata visitColumn(TupleSchemaParser.ColumnContext ctx) {
      TupleSchemaParser.Column_attrContext column_attrContext = ctx.column_attr();

      boolean nullable = column_attrContext.nullability() == null;
  ...
  public static void main(String[] args) {
    ...
    builder = builder.addMap("m").resumeMap().resumeSchema();
  }

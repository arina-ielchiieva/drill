...
public class TestCTTAS extends BaseTestQuery {
  ...
  public static void init() throws Exception {
    final MockUp<UUID> uuidMockUp = mockRandomUUID(session_id);
    ...
    final FileSystemConfig pluginConfig = (FileSystemConfig) pluginRegistry.getPlugin(test_schema).getConfig();

 ...
 * Should be initialized using {@link Builder}, constructor is made public only for ser / de purposes.
 */
...
public class ParquetReaderConfig {
  ...
  // keep variables public for ser / de to avoid creating getters and constructor with params for all variables

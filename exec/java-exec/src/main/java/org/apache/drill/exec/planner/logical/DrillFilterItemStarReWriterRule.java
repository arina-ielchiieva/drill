...
public class DrillFilterItemStarReWriterRule extends RelOptRule {
   ...
   * For fields with the same name, stores original calls in a list, does not duplicate fields.
  ...
  private class ItemStarFieldsVisitor extends RexVisitorImpl<RexNode> {
    ...
    public RexNode visitCall(RexCall call) {
      ...
      String fieldName = FieldsReWriterUtil.getFieldNameFromItemStarColumn(call, fieldNames);
      if (fieldName != null) {

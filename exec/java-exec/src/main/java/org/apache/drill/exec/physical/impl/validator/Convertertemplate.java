...
public abstract class ConverterTemplate implements Converter {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ConverterTemplate.class);
  ...
  @Override
  public int convertRecords(int startIndex, int recordCount, int firstOutputIndex) {
    try {

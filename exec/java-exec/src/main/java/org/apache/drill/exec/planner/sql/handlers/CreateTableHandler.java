...
public class CreateTableHandler extends DefaultSqlHandler {
  ...
  public PhysicalPlan getPlan(SqlNode sqlNode) throws ValidationException, RelConversionException, IOException, ForemanSetupException {
    ...
    checkDuplicatedObjectExistence(drillSchema, newTblName, isTemporaryWorkspace, context.getSession());
    ...
    String finalTableName = sqlCreateTable.isTemporary() ?
        context.getSession().registerTemporaryTable(drillSchema, newTblName) : newTblName;

    DrillRel drel = convertToDrel(newTblRelNodeWithPCol, drillSchema, finalTableName,

...
public class ParquetFormatConfig implements FormatPluginConfig {
  ...
  /**
   * Parquet statistics for UTF-8 data for files created prior to 1.9.1 parquet library was stored incorrectly.
   * If user exactly knows that data in binary columns in ASCII (not UTF-8), turning this property to 'true'
   * enables statistics usage for varchar and decimal columns.
   *
   * Applicable across all workspace, can be overridden for individual tables using

...
public class StoragePluginRegistryImpl implements StoragePluginRegistry {
  ...
  public StoragePluginRegistryImpl(DrillbitContext context) {
    ...
    this.pluginSystemTable = initPluginSystemTable(context, lpPersistence);
  ...
  /**
   * <ol>
   *   <li>Creates or gets persistent store for plugins.</li>
   ...
   * @param lpPersistence deserialization mapper provider
   * @return plugin system table
   */
  private PersistentStore<StoragePluginConfig> initPluginSystemTable(DrillbitContext context, LogicalPlanPersistence lpPersistence) {
    try {

...
public class StringFunctions{
  ...
  @FunctionTemplate(names = {"substring", "substr"}, scope = FunctionScope.SUBSTRING, nulls = NullHandling.NULL_IF_NULL)
  ...
  @FunctionTemplate(names = {"substring", "substr" }, scope = FunctionScope.SUBSTRING, nulls = NullHandling.INTERNAL)
  ...
  @FunctionTemplate(name = "left", scope = FunctionScope.STRING_LEFT_RIGHT, nulls = NullHandling.NULL_IF_NULL)
  ...
  @FunctionTemplate(name = "right", scope = FunctionScope.STRING_LEFT_RIGHT, nulls = NullHandling.NULL_IF_NULL)
   ...
   */
  @FunctionTemplate(name = "lpad", scope = FunctionScope.PAD, nulls = NullHandling.NULL_IF_NULL)
   ...
   */
  @FunctionTemplate(name = "rpad", scope = FunctionScope.PAD, nulls = NullHandling.NULL_IF_NULL)
  ...
  @FunctionTemplate(name = "concatOperator", scope = FunctionScope.CONCAT, nulls = NullHandling.NULL_IF_NULL)
  ...
  @FunctionTemplate(name = "concat", scope = FunctionScope.CONCAT, nulls = NullHandling.INTERNAL)

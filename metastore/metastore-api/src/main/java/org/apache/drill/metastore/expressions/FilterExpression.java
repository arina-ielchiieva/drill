...
public interface FilterExpression {
  ...
  static FilterExpression and(FilterExpression right, FilterExpression left, FilterExpression... expressions) {
    FilterExpression finalExpression = and(right, left);
    for (FilterExpression expression : expressions) {
      finalExpression = and(finalExpression, expression);
    }
  ...
  static FilterExpression or(FilterExpression right, FilterExpression left, FilterExpression... expressions) {
    FilterExpression finalExpression = or(right, left);
    for (FilterExpression expression : expressions) {
      finalExpression = or(finalExpression, expression);
    }
    return finalExpression;
  }
}

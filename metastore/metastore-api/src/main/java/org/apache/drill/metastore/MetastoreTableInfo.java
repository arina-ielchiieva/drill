...
/**
 * Holds metastore table information, including table information, exists status,
...
public class MetastoreTableInfo {
  ...
  public static MetastoreTableInfo of(TableInfo tableInfo, MetadataUnit unit, long metastoreVersion) {
   ...
   *   <li>If table existed but now does not, return true.</li>
   ...
   *   <li>If both last modified times are the same, return true.</li>
   *   <li>If both last modified times are different, return false.</li>
   * </ul>
   *

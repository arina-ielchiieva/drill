...
/**
 * Class that represents one row in Drill Metastore which is a generic representation of metastore metadata
 * suitable to any metastore metadata type (table, segment, file, row group, partition).
 * Is used to read and write data from / to Drill Metastore implementation.
 */
public class MetadataUnit {

  public static final Schema SCHEMA = Schema.of(MetadataUnit.class, Builder.class);
  ...
  private MetadataUnit(Builder builder) {
  ...
  public boolean equals(Object o) {
    ...
    MetadataUnit that = (MetadataUnit) o;
  ...
  public String toString() {
    return new StringJoiner(",\n", MetadataUnit.class.getSimpleName() + "[", "]")
  ...
  public static class Builder {
    ...
    public MetadataUnit build() {
      return new MetadataUnit(this);
    }
  }
  ...
  public static class Schema {
     ...
     * Goes through the list of unit class fields which are annotated with {@link MetastoreFieldDefinition}

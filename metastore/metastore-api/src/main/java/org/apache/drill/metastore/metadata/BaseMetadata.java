...
public abstract class BaseMetadata implements Metadata {
  ...
  @Override
  public MetadataUnit toMetadataUnit() {
  ...
  protected abstract void toMetadataUnitBuilder(MetadataUnit.Builder builder);
  ...
  public static abstract class BaseMetadataBuilder<T extends BaseMetadataBuilder<T>> {
    ...
    public T metadataUnit(MetadataUnit unit) {
    ...
    protected abstract T metadataUnitInternal(MetadataUnit unit);
  }
}

...
/**
 * Basic metadata transformer class which can transform given list of {@link MetadataUnit}
...
public class BasicTransformer {
  ...
  public static List<BaseTableMetadata> tables(List<MetadataUnit> units) {
    return units.stream()
  ...
  public static List<SegmentMetadata> segments(List<MetadataUnit> units) {
    return units.stream()
  ...
  public static List<FileMetadata> files(List<MetadataUnit> units) {
    return units.stream()
  ...
  public static List<RowGroupMetadata> rowGroups(List<MetadataUnit> units) {
    return units.stream()
  ...
  public static List<PartitionMetadata> partitions(List<MetadataUnit> units) {
    return units.stream()
  ...
  public static MetadataHolder all(List<MetadataUnit> units) {

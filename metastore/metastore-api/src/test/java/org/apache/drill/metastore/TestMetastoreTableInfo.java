...
public class TestMetastoreTableInfo {
  ...
  public void testExistingTable() {
    MetadataUnit unit = MetadataUnit.builder().lastModifiedTime(System.currentTimeMillis()).build();
  ...
  public void testHasChangedSameNullModificationTime() {
    MetadataUnit unit = MetadataUnit.builder().build();
    MetastoreTableInfo metadata = MetastoreTableInfo.of(TableInfo.UNKNOWN_TABLE_INFO, unit, 1);
  ...
  public void testHasChangedSameDefinedModificationTime() {
    ...
    MetadataUnit unit = MetadataUnit.builder().lastModifiedTime(lastModificationTime).build();
    MetastoreTableInfo metadata = MetastoreTableInfo.of(TableInfo.UNKNOWN_TABLE_INFO, unit, 1);
  ...
  public void testHasChangedDifferentDefinedModificationTime() {
    MetadataUnit unit = MetadataUnit.builder().lastModifiedTime(100L).build();
    MetastoreTableInfo metadata = MetastoreTableInfo.of(TableInfo.UNKNOWN_TABLE_INFO, unit, 1);

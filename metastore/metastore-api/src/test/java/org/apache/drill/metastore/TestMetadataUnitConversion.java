...
public class TestMetadataUnitConversion {
  ...
  public void testBaseTableMetadata() {
    ...
    MetadataUnit requiredFieldsExpectedUnit = MetadataUnit.builder()
    ...
    MetadataUnit requiredFieldsUnit = requiredFieldsMetadata.toMetadataUnit();
    ...
    MetadataUnit allFieldsExpectedUnit = MetadataUnit.builder()
      .storagePlugin(tableInfo.storagePlugin())
      .workspace(tableInfo.workspace())
      .tableName(tableInfo.name())
      .owner(tableInfo.owner())
    ...
    MetadataUnit allFieldsUnit = allFieldsMetadata.toMetadataUnit();
  ...
  public void testFileMetadata() {
    ...
    MetadataUnit expectedUnit = MetadataUnit.builder()
      .storagePlugin(tableInfo.storagePlugin())
      .workspace(tableInfo.workspace())
      .tableName(tableInfo.name())
      .metadataType(metadataInfo.type().name())
    ...
    MetadataUnit actualUnit = metadata.toMetadataUnit();

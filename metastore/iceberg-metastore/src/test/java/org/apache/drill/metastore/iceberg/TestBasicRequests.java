...
import org.apache.drill.metastore.BasicTransformer;
import org.apache.drill.metastore.BasicRequests;
import org.apache.drill.metastore.Metastore;
import org.apache.drill.metastore.MetadataUnit;
import org.apache.drill.metastore.MetastoreTableInfo;
...
public class TestBasicRequests extends IcebergBaseTest {
  ...
  private static BasicRequests basicRequests;
  private static MetadataUnit nationTable;
  private static TableInfo nationTableInfo;

  @BeforeClass
  public static void init() {
    DrillConfig config = new DrillConfig(baseIcebergConfig(defaultFolder.getRoot()));
    metastore = new IcebergMetastore(config).get();
    prepareData(metastore);
    basicRequests = metastore.basicRequests();
  }
  ...
  public void testHasMetastoreTableInfoChangedTrue() {
    MetadataUnit unit = nationTable.toBuilder()
    ...
    MetadataUnit updatedUnit = unit.toBuilder()
      .lastModifiedTime(2L)
      .build();
    metastore.modify()
  ...
  public void testTablesMetadataAbsent() {
    List<BaseTableMetadata> tablesMetadata = basicRequests.tablesMetadata(
      FilterExpression.and(
        FilterExpression.equal(IcebergTableSchema.STORAGE_PLUGIN, "dfs"),
        FilterExpression.equal(IcebergTableSchema.WORKSPACE, "absent")));
  ...
  public void testTablesMetadataExisting() {
    List<BaseTableMetadata> baseTableMetadata = basicRequests.tablesMetadata(
      FilterExpression.and(
        FilterExpression.equal(IcebergTableSchema.STORAGE_PLUGIN, "dfs"),
        FilterExpression.equal(IcebergTableSchema.WORKSPACE, "tmp")));
  ...
  public void testFullSegmentsMetadataWithoutPartitions() {
    BasicTransformer.MetadataHolder metadataHolder = basicRequests.fullSegmentsMetadataWithoutPartitions(
      nationTableInfo,
  ...
  public void testInterestingColumnsAndPartitionKeys() {
    MetadataUnit result = basicRequests.interestingColumnsAndPartitionKeys(nationTableInfo);
  ...
  public void testCustomRequest() {
    ...
    List<MetadataUnit> units = basicRequests.request(requestMetadata);
   ...
   *
   * @param metastore Drill Metastore instance
   */
  private static void prepareData(Metastore metastore) {
    ...
    MetadataUnit nationSegment1 = nationTable.toBuilder()
    ...
    MetadataUnit nationSegment2 = nationTable.toBuilder()
      .metadataType(MetadataType.SEGMENT.name())
      .metadataKey("part_int=3")
    ...
    MetadataUnit nationSegment3 = nationTable.toBuilder()
      .metadataType(MetadataType.SEGMENT.name())
    ...
    MetadataUnit nationPartition1 = nationTable.toBuilder()
      .metadataType(MetadataType.PARTITION.name())
      .metadataKey("part_int=3")
    ...
    MetadataUnit nationPartition2 = nationTable.toBuilder()
      .metadataType(MetadataType.PARTITION.name())
      .metadataKey("part_int=4")
      .location("/tmp/nation/part_int=4/d5")
      .column("n_nation")
    ...
    MetadataUnit nationPartition3 = nationTable.toBuilder()
      .metadataType(MetadataType.PARTITION.name())
      .metadataKey("part_int=4")
      .column("n_region")
    ...
    MetadataUnit nationFile1 = nationTable.toBuilder()
    ...
    MetadataUnit nationFile2 = nationTable.toBuilder()
      .metadataType(MetadataType.FILE.name())
      .metadataKey("part_int=3")
      .location("/tmp/nation/part_int=3/part_varchar=g")
    ...
    MetadataUnit nationFile3 = nationTable.toBuilder()
      .metadataType(MetadataType.FILE.name())
      .metadataKey("part_int=4")
    ...
    MetadataUnit nationRowGroup1 = nationTable.toBuilder()
    ...
    MetadataUnit nationRowGroup2 = nationTable.toBuilder()
      .metadataType(MetadataType.ROW_GROUP.name())
      .metadataKey("part_int=3")
      .location("/tmp/nation/part_int=3/part_varchar=g")
      .path("/tmp/nation/part_int=3/part_varchar=g/0_0_0.parquet")
    ...
    MetadataUnit nationRowGroup3 = nationTable.toBuilder()
      .metadataType(MetadataType.ROW_GROUP.name())
      .metadataKey("part_int=4")
      .location("/tmp/nation/part_int=4/part_varchar=g")
      .path("/tmp/nation/part_int=4/part_varchar=g/0_0_0.parquet")
    ...
    MetadataUnit nationRowGroup4 = nationTable.toBuilder()
      .metadataType(MetadataType.ROW_GROUP.name())
      .metadataKey("part_int=4")
      .location("/tmp/nation/part_int=4/part_varchar=g")
      .path("/tmp/nation/part_int=4/part_varchar=g/0_0_0.parquet")
    ...
    MetadataUnit regionTable = basicUnit().toBuilder()
      .tableName("region")
      .metadataType(MetadataType.TABLE.name())
      .metadataKey(MetadataInfo.GENERAL_INFO_KEY)
      .build();
   ...
   */
  private static MetadataUnit basicUnit() {
    return MetadataUnit.builder()
      .storagePlugin("dfs")
      .workspace("tmp")
      .tableName("test")
      .owner("user")
